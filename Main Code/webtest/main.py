...
parser.add_argument('--stock_code', nargs='+', default='model_kospi_2')
...
parser.add_argument('--output_name', default='model_kospi')
parser.add_argument('--value_network_name', default='a2c_lstm_value_c_kospi')
parser.add_argument('--policy_network_name', default='a2c_lstm_policy_c_kospi')
parser.add_argument('--reuse_models', action='store_true')
parser.add_argument('--learning', action='store_true')
parser.add_argument('--start_date', default='20201001')
parser.add_argument('--end_date', default='20201020')
...
chart_data, training_data = data_manager.load_data(
    ...
    'data/{}/{}.csv'.format(args.ver, args.stock_code)),
